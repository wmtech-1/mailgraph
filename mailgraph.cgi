...
my @graphs = (
        ...
        { title => 'Last 12 Hours',   seconds => 3600*12,        },
        { title => 'Last 24 Hours',   seconds => 3600*24,        },
        { title => 'Last 7 Days',  seconds => 3600*24*7,      },
        { title => 'Last 31 Days', seconds => 3600*24*31,     },
        { title => 'Last 365 Days',  seconds => 3600*24*365, },
        { title => 'Last 2 Years',  seconds => 3600*24*365*2, },
        { title => 'Last 5 Years',  seconds => 3600*24*365*5, },
);
